  ...
  return (
    <section>
      <Element name="About Me">
        <div className="container-aboutme relative">
          {/* Introduction Section */}
          <div className="caption-aboutme uppercase text-p2">ABOUT ME</div>

          <h6 className="ml-4 text-2xl text-p4 mb-2 font-semibold">Introduction</h6>
          <div className="relative mb-10 p-8 border-2 border-s3 rounded-7xl g7">
            <div className="text-xl">
              I am Shounak Mulay, an IT undergraduate passionate about full-stack development, cloud technologies, and creating scalable solutions. With a knack for problem-solving and innovation, I thrive on crafting impactful applications.
            </div>
          </div>
          ...
          {/* Education Section */}
          <h2 className="ml-4 text-2xl text-p4 mb-2 font-semibold">Education</h2>
          ...
          {/* Experience Section */}
          <h2 className="ml-4 text-2xl text-p4 mb-2 font-semibold">Experience</h2>
          <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
            {experience.map(({ id, position, title, text }) => (
              <div
                key={id}
              ...
              >
                ...
                <p className="mb-11 max-md:mb-8 max-md:body-3 text-[80%]">{text}</p>
              </div>
            ))}
          </div>
        </div>
