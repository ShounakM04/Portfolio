...
export const links = [
  {
    platform: "LinkedIn",
    url: "https://www.linkedin.com/in/shounakmulay26",
...
export const projects = [
  {
    ...
    description: "A blockchain-based system to verify the authenticity of products, reducing counterfeit goods in the market. This system ensures trust by leveraging secure and immutable blockchain technology.",
    techStack: [
      { name: "PostgreSQL", img: "/images/pg.png" },
      { name: "Express", img: "/images/express.png" },
      { name: "React", img: "/images/react.png" },
      { name: "Node.js", img: "/images/node.png" },
      { name: "Tailwindcss", img: "/images/tailwind.png" },
    ],
    link: "https://github.com/ShounakM04/Fake-Product-Identification"
  },
  {
    id: 2,
    image: "images/Project4.png",
    title: "Vehicle Dealership - Nikhil Motors",
    description: "A comprehensive dealership management platform for vehicles, allowing users to browse, manage inventory, and schedule maintenance. Integrated with AWS for secure image hosting and scalable operations.",
    techStack: [
      { name: "PostgreSQL", img: "/images/pg.png" },
      { name: "Express", img: "/images/express.png" },
      { name: "React", img: "/images/react.png" },
    ...
    link: "https://github.com/ShounakM04/Vehicle-Dealership"
  },
  {
    id: 3,
    image: "images/Project2.png",
    title: "RescueBites",
    description: "A platform for reducing food waste by connecting restaurants with surplus food to individuals in need. Facilitates easy listing, tracking, and sharing of food resources in a community.",
    techStack: [
      { name: "PostgreSQL", img: "/images/pg.png" },
      { name: "Express", img: "/images/express.png" },
      { name: "React", img: "/images/react.png" },
    ...
    link: "https://github.com/ShounakM04/Leftover-Food-Management"
  },
  {
    id: 4,
    image: "images/image.png",
    title: "Portfolio Website",
    description: "A personal portfolio showcasing projects, skills, and achievements. Built with a clean and responsive design for an engaging user experience.",
    techStack: [
      { name: "React", img: "/images/react.png" },
      { name: "Tailwindcss", img: "/images/tailwind.png" }
    ],
...
export const education = [
  ...
  {
    id: "1",
    institution: "Late P.B Jog Junior College",
    degree: "High School",
    timeline: "2020 - 2022",
  },
];
